            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ItemStatus(status: 'Available', color: Colors.white),
                    ItemStatus(status: 'Filled', color: Color(0xFFFF8B2D)),
                    ItemStatus(status: 'Selected', color: Color(0xFF656CEE)),
                  ],
                ),
              ),
              SizedBox(height: 10),
